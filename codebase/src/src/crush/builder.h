 ...
 */
extern void crush_rule_set_step(struct crush_rule *rule, 
                                int pos,
                                int op,
                                int arg1,
                                int arg2);
 ...
 */
struct crush_bucket *crush_make_bucket(struct crush_map *map, 
                                       int alg, 
                                       int hash, 
                                       int type, 
                                       int size, 
...
extern struct crush_choose_arg *crush_make_choose_args(struct crush_map *map,
                                                       int num_positions);

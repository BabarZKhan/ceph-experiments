...
(
    const struct crush_map *map, // pointer variable/pass by reference/stored externally/off-chip
	struct crush_work  *work,     // pointer variable/pass by reference/stored externally/off-chip
	const struct crush_bucket *bucket,// pointer variable/pass by reference/stored externally/off-chip
	int *out,                    // pointer variable/pass by reference/stored externally/off-chip
	const __u32 *weight,         // pointer variable/pass-by-reference/stored externally/off-chip
	int *out2,                   // pointer variable/pass by reference/stored externally/off-chip
	const struct crush_choose_arg *choose_args // pointer variable/pass by reference/stored externally/off-chip
	
	int weight_max,
    int x,                               //  integer (scalar) input, passed by value 
	int numrep,                          //  integer (scalar) input, passed by value
	int type,                            //  integer (scalar) input, passed by value
	int outpos,                          //  integer (scalar) input, passed by value
	int out_size,                        //  integer (scalar) input, passed by value
	unsigned int tries,                  //  integer (scalar) input, passed by value
	unsigned int recurse_tries,          //  integer (scalar) input, passed by value
    unsigned int local_retries,          //  integer (scalar) input, passed by value
	unsigned int local_fallback_retries, //  integer (scalar) input, passed by value
    int recurse_to_leaf,                 //  integer (scalar) input, passed by value
	unsigned int vary_r,                 //  integer (scalar) input, passed by value
	unsigned int stable,                 //  integer (scalar) input, passed by value
	int parent_r,                        //  integer (scalar) input, passed by value
...
parent_r %d stable %d\n",
    ...
    // Condition ? X : Y ...If condition is true then return X or else Y
...
int crush_do_rule(
   ...
   const struct crush_map *map,               // pointer variable/pass-by-reference/stored externally/off-chip
   const struct crush_choose_arg *choose_args,// pointer variable/pass-by-reference/stored externally/off-chip
   void *cwin,          // pointer variable/pass-by-reference/stored externally/off-chip
   const __u32 *weight, // pointer variable/pass-by-reference/stored externally/off-chip
   int *result,         // pointer variable/pass-by-reference/stored externally/off-chip
                   
   int ruleno,     //  integer (scalar) input, passed by value
   int x,          //  integer (scalar) input, passed by value
   int result_max, //  integer (scalar) input, passed by value
   int weight_max  //  integer (scalar) input, passed by value	                        
		         )

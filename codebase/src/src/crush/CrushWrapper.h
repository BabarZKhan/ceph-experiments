...
public:
 ...
 void do_rule (
               int        rule                   ,
               int        x                      ,
               std::vector<int>& out             , // passing vector as a reference
               int        maxout                 ,
	           const      WeightVector& weight   , // passing by reference
  ...
  // Call the function crush_do_rule through 
  // the crush algorithm to find the appropriate osd collection           
   
  int numrep = crush_do_rule(
                            crush, 
                            rule,
                            x, 
                            rawout, 
